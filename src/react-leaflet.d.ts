...
declare module "react-leaflet" {
  ...
  export class LeafletConsumer extends React.Component<any, any> {}
  export interface LeafletContext {
    map?: Leaflet.Map;
  }
  export function withLeaflet(wrappedComponent: React.ComponentType<any>): any;
  ...
  export interface WMSTileLayerProps
    extends TileLayerEvents,
      Leaflet.WMSOptions {
    children?: Children;
    url: string;
